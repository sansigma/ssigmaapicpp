...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ssigmaapi_2ftype_2forderbook_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_ssigmaapi_2ftype_2forderbook_2eproto {
...
class BidAsk final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssigmaapi.type.BidAsk) */ {
 public:
  BidAsk();
  virtual ~BidAsk();
  ...
  inline BidAsk* New() const final {
    return CreateMaybeMessage<BidAsk>(nullptr);
  }
 ...
 private:
  ...
  friend struct ::TableStruct_ssigmaapi_2ftype_2forderbook_2eproto;
};
// -------------------------------------------------------------------

class OrderBook final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ssigmaapi.type.OrderBook) */ {
 public:
  OrderBook();
  virtual ~OrderBook();
